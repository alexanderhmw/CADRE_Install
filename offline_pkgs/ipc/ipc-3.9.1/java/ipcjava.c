...
JNIEXPORT jshort JNICALL Java_ipc_java_primFmttrs_formatGetShort (JNIEnv *env, jclass c,
						       jlong buffer)
{
  return (jshort)formatGetShort((BUFFER_PTR)(size_t)buffer);
}

JNIEXPORT void JNICALL Java_ipc_java_primFmttrs_formatPutShort (JNIEnv *env, jclass c,
						       jlong buffer, jshort theShort)
{
  formatPutShort((BUFFER_PTR)(size_t)buffer, (int32)theShort);
}


JNIEXPORT jshort JNICALL Java_ipc_java_primFmttrs_formatGetUShort (JNIEnv *env, jclass c,
						       jlong buffer)
{
  return (jshort)formatGetUShort((BUFFER_PTR)(size_t)buffer);
}

JNIEXPORT void JNICALL Java_ipc_java_primFmttrs_formatPutUShort (JNIEnv *env, jclass c,
						       jlong buffer, jshort theShort)
{
  formatPutUShort((BUFFER_PTR)(size_t)buffer, (int32)theShort);
}
...
JNIEXPORT jint JNICALL Java_ipc_java_primFmttrs_formatGetUInt (JNIEnv *env, jclass c,
						     jlong buffer)
{
  return (jint)formatGetUInt((BUFFER_PTR)(size_t)buffer);
}

JNIEXPORT void JNICALL Java_ipc_java_primFmttrs_formatPutUInt (JNIEnv *env, jclass c,
						     jlong buffer, jint theInt)
{
  formatPutUInt((BUFFER_PTR)(size_t)buffer, (int32)theInt);
}
