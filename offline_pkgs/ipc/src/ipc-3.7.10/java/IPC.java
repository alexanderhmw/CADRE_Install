/*****************************************************************************
 *       $Id: IPC.java,v 1.3 2002/01/11 22:35:23 reids Exp $
 * $Revision: 1.3 $
 *     $Date: 2002/01/11 22:35:23 $
 *   $Author: reids $
 *    $State: Exp $
 *   $Locker:  $
 *
...
public class IPC {
  ...
  public static class IPC_CONTEXT {
    IPC_CONTEXT(int theCptr) { cptr = theCptr; }
    int cptr;
  };
  ...
  private native static int IPC_dataLength (int msgInstance);
  private native static String IPC_msgInstanceName (int msgInstance);
  private native static int IPC_msgInstanceFormatter (int msgInstance);
  ...
  private native static int IPC_respond (int msgInstance, String msgName,
					 int length, int byteArray);
  ...
  private native static int IPC_removeTimerByRef(int timerRef);
  ...
  private static Object unmarshallMsgData (int formatter, int byteArray,
					   Class msgDataClass) 
      throws Exception {
    Object object = null;
  ...
  private static void msgCallbackHandler (int handlerNum, int msgInstance,
					  int byteArray) {
