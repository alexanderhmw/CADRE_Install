...
config = {
    ...
    "pkg": {
        ...
        'postcmds': ['sudo apt-get update',
                     'sudo apt-get install libcudnn8={}-{}+cuda{} -y'.format(ConfigFunc.version_str(version_list, "."), subverions, ConfigFunc.version_str(cuda_version_list, ".")),
                     'sudo apt-get install libcudnn8-dev={}-{}+cuda{} -y'.format(ConfigFunc.version_str(version_list, "."), subverions, ConfigFunc.version_str(cuda_version_list, "."))]
    },
    "dependencies": ["cuda11"]
}
